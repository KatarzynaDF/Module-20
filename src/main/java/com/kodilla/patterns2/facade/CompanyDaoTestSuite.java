...
public class CompanyDaoTestSuite {
    ...
    public void testQueries() {
        ...
        //When
        List<Employee> smithName = employeeDao.findByLastName(LASTNAME);
    ...
    @Test
    public void testQueryCompanyFasadeLookingForCompany() {
        ...
        try {
            matchingCompaniesName = lookingFacade.findCompany("est");
